 ...
 * 
 * The ResourcesParent will run a job to retrieve all current resources. It will
 * also watch for updates to resources. There is is a chance the view might get
 * slightly out of date, due to the time between retrieve all and the watches.
 * 
