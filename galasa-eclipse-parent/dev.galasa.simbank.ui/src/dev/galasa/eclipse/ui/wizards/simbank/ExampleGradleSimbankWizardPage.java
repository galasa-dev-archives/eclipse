...
public class ExampleGradleSimbankWizardPage extends WizardPage implements Listener {

    private Text            prefixNameField;
    private Label           parentProjectName;
    private Label           testProjectName;
    private Label           managerProjectName;

    private static String[] invalidCharacters = { "!", "@", "£", "$", "^", "&", "*", };

    public ExampleGradleSimbankWizardPage(String pageName) {
        super(pageName);
    ...
    public void createControl(Composite parent) {
        ...
        Label parentLabel = new Label(projectsGroup, SWT.NONE);
        parentLabel.setText("Parent project:");
        parentLabel.setFont(parent.getFont());

        parentProjectName = new Label(projectsGroup, SWT.NONE);
        parentProjectName.setFont(parent.getFont());
    ...
    private void setProjectNames() {
        ...
        parentProjectName.setText(prefix + ".parent");
    ...
    private boolean validatePage() {
        ...
        IProject parentProject = ResourcesPlugin.getWorkspace().getRoot().getProject(parentProjectName);
        if (parentProject.exists()) {
            setErrorMessage("The resulting parent project name already exists in this workspace");
            setMessage(null);
            return false;
        }
